    ...
    return (
        <>
            ...
            <div className='px-20 bg-gray-900'>
                <header className="sticky top-8 rounded-full bg-black shadow">
                ...
                <header className="px-2 py-4 mt-16 flex flex-col justify-center items-center text-center">
                    <img className="inline-flex object-cover border-4 border-pink-600 rounded-full shadow-[5px_5px_0_0_rgba(0,0,0,1)] shadow-pink-600/100 bg-pink-50 text-pink-600 h-24 w-24 " src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NzEyNjZ8MHwxfHNlYXJjaHwyfHxoZWFkc2hvdHxlbnwwfDB8fHwxNjk1ODE3MjEzfDA&ixlib=rb-4.0.3&q=80&w=1080" alt="" />
                    ...
                    <h2 className="text-base md:text-xl text-gray-500 font-bold">
                        ...
                        <a href="" target="_blank"
                            className="text-pink-900 hover:text-pink-600 font-bold border-b-0 hover:border-b-4 hover:border-b-pink-300 transition-all mb-2">
                            XYZ
                        </a>
                    </h2>
                    <ul className="flex flex-row mt-2">
                        <li className="mx-2">
                            <a href="" target="_blank" aria-label="GitHub">
                                <svg className="h-6 text-pink-700 hover:text-pink-300" fill="currentColor" role="img" viewBox="0 0 24 24"
                ...
                <div className='flex justify-center items-center'>
                    <button className="px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg">
                        Post new blog
                    </button>
                </div>

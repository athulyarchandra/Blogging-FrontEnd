...
const PostDetails = () => {
  ...
  return (
    <>
      ...
      <section className="relative px-20 bg-gray-900 ">
        <div className="w-full  px-5 lg:px-11 mx-auto max-md:px-3">
          <div className=" ">
            <div className="">
              ...
              <div className="py-8">
                <div className="flex justify-between relative mb-16">
                  <svg className="absolute top-0 left-0 w-8" width="32" height="30" viewBox="0 0 32 30" fill="none"
                    ...
                    <defs>
                      <linearGradient id="paint0_linear_9284_62585" x1="15.1556" y1="1.68661" x2="-7.59931" y2="11.975"
                        ...
                        <stop offset="0.993738" stop-color="#EC4899" />
                      </linearGradient>
                  ...
                  <h4 className="font-manrope font-semibold text-2xl leading-9 text-white max-w-[609px] mx-auto max-lg:px-8">
                    {blog?.title}
                  </h4>
                  <svg className="absolute right-0 bottom-0 w-8" width="32" height="30" viewBox="0 0 32 30" fill="none"
                    ...
                    <defs>
                      ...
                      <linearGradient id="paint1_linear_9553_63113" x1="0.000648535" y1="27.7528" x2="22.7556" y2="17.4644" gradientUnits="userSpaceOnUse">
                        <stop stop-color="#EC4899" />
                        <stop offset="0.993738" stop-color="#EC4899" />
                      </linearGradient>
                    </defs>
                ...
                <div className="w-[94%] mx-auto flex gap-1 items-center text-white sm:text-[12px] xs:text-[10px] font-semibold dark:text-gray-300">
                
                <p className="font-semibold text-md"> {blog?.description}</p>
              
              </div>
                <p className="text-gray-500 text-sm">Published on <time datetime="2022-04-05">{blog?.createdAt}</time></p>
              </div>
             

<div className='flex justify-center items-center'>
  
                <img style={{height:'750px'}} src={`${SERVER_URL}/uploads/${blog.blogImg}`} alt="Featured image" className="w-full mb-8" />
  
</div>

              <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto pb-5 text-white">
                <p>{blog?.content}</p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white dark:bg-gray-800  h-full py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <section className="w-full rounded-lg border-2 border-white p-4 ">
            <h3 className="font-os text-lg  text-white font-bold">Comments</h3>
            ...
            <div className="flex mt-4">
              ...
              <div className="ml-3">
                ...
                <div className="text-gray-400">Posted on date</div>
                <div className="mt-2 text-white">comment
                </div>
              </div>
            </div>
            <form className="mt-4">
              <div className="mb-4">
                <label for="name" className="block text-white font-medium">Name</label>
                <input type="text" id="name" name="name"
                  className="border-2 border-white p-2 w-full rounded" required />
              </div>

              <div className="mb-4">
                <label for="comment" className="block text-white font-medium">Comment</label>
                <textarea id="comment" name="comment" className="border-2 border-white p-2 w-full rounded" required></textarea>
              </div>

              <button type="submit"
                className="bg-pink-700 text-white font-medium py-2 px-4 rounded hover:bg-white">Post
                Comment
              </button>
            </form>
          </section>
      ...
      <footer className="w-full bg-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
            ...
            <li><Link to={'/dashboard'} className="text-white hover:text-gray-400">My Blogs</Link></li>
            <li><Link to={'/blogs'} className="text-white hover:text-gray-400">All Blogs</Link></li>
            <li><Link to={'/dashboard'} className="text-white hover:text-gray-400">Dashboard</Link></li>
            <li><Link to={'/*'} className="text-white hover:text-gray-400">Support</Link></li>
            <li><a href="javascript:;" className="text-white hover:text-gray-400"></a></li>
              <li><a href="javascript:;" className="text-white hover:text-gray-400">Blog</a></li>
              <li><a href="javascript:;" className="text-white hover:text-gray-400"></a></li>
            </ul>
            <div className="flex  space-x-4 sm:justify-center  ">
              <a href="javascript:;"
                className="w-9 h-9 rounded-full bg-gray-800 flex justify-center items-center hover:bg-pink-600">
          ...
          <div className="py-7 border-t border-gray-700">
            <div className="flex items-center justify-center">
              <span className="text-gray-400 ">©pagedone 2025, All rights reserved.</span>
            </div>
          </div>
        </div>
      </footer>
